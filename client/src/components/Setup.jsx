    ...
    return (
        <>
            ...
            <details>
                ...
                <p>Open a terminal and run Ganache, a simulated Ethereum blockchain on your machine.</p>
                <code>$ ganache</code>
            ...
            <details>
                ...
                <code>
                    ...
                    <span className='dim-color'>
                        # The `development` network points to Ganache, it's configured in truffle/truffle-config.js on
                        line 45.
                    </span>
                </code>
            </details>
